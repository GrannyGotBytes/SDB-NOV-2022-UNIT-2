...
// Combining two or more strings is called concatination.
...
let calculatedTip = 50 * .25 * 100;
console.log(calculatedTip.toFixedtoFixed(2));
...
/* 
undefined
- no value is assigned and does not actr as an emppty container

*/
var myName;
// because we did not assigned and does not act as an empty container

var myLastName = undefined;
var myAddress = "123 main st";
var notNumber = "name" /  "15";
// Using Boolean we can check to see if a variable containes data
